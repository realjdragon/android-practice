...
public class MainActivity extends AppCompatActivity {
    ArrayList<ItemDeal> deals = new ArrayList<ItemDeal>();
    ...
    private void getMobileHomeMain() {
        ...
        JsonObjectRequest jr = new JsonObjectRequest(
                apiUrl,
                null,
                homeMainApiResponseListener,
                homeMainApiErrorListener
        ){
            @Override
    ...
    private Response.Listener<JSONObject> homeMainApiResponseListener = new Response.Listener<JSONObject>() {
        @Override
    ...
    private Response.ErrorListener homeMainApiErrorListener = new Response.ErrorListener() {
        @Override
